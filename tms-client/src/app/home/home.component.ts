  ...
  template: `
    <section class="hero">
      <div>
        ...
        <p>
          Streamline your workflow with out intuitive task management system.
        ...
        <div class="btn_container">
          ...
          <button class="btn project_btn" routerLink="/projects/projects-add">
            <svg
              class="w-6 h-6 text-gray-800 dark:text-white"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
    ...
    <section>
      ...
      <div>
        ...
        <div class="card">
          ...
          <p>
            Monitor progress with status options: Pending, In Progrss, and
        ...
        <div class="card">
          ...
          <p>
            Set priorities as High, Medium, or Low to focus on what matters most
